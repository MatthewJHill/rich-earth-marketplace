...
class RichEarthMarketplaceSupabaseUser extends BaseAuthUser {
  RichEarthMarketplaceSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> richEarthMarketplaceSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = RichEarthMarketplaceSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
