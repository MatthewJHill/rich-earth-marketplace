...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF194E16);
  late Color secondary = const Color(0xFF4E1627);
  late Color tertiary = const Color(0xFF3D164E);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFF14181B);
  late Color secondaryText = const Color(0x82BAD1B7);
  late Color primaryBackground = const Color(0xFFF1F4F8);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0x4C19DB8A);
  late Color accent2 = const Color(0xFF74263A);
  late Color accent3 = const Color(0xFF713A84);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color secondaryText = const Color(0xFFBAD1B7);
